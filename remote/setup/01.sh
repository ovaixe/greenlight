...
# Set the timezone for the server. A full list of available timezones can be found by running timedetectl list-timezones.
...
# Force all output to be presented in en_US for the duration of this script. This avoids any "setting locale failed" errors while this script is running, before we have installed support for all locales. Do not change this setting!
...
# Add a DSN for connecting to the greenelight database to the system-wide environment variables in the /etc/environment file.
