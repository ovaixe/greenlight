...
func (app *application) createMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Call the Insert() method on our movies model, passing in a pointer to the validated movie strcut. This will create a record in the database and update the movie struct with the system-generated information.
...
// Add a showMovieHandler for the "GET /v1/movies" endpoint.
func (app *application) showMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Encode the struct to JSON and send it as the response.
